...
if __name__=='__main__':
    ...
    args.dataset = 'meld'#'dialogues'#'meld' #neutral-0, joy-2, surprise-6, sadness-3, anger-5, disgust-1, and fear-4
    args.dataset2 = 'emory'#sad-3, mad-5, scared-4, powerful-6, peaceful-1, joyful-2, and neutral-0
    args.dataset3 = 'iemocap'#happiness-2, sadness-3, anger-4, frustration-1, excited-5, and neutral-0
